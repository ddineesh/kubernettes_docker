...
Run com.dinesh.microservices.currencyconversionservice.CurrencyConversionServiceApplicationH2 as a Java Application.
...
#### Basic
```
docker container run --publish 8000:8000 ddineesh/currency-exchange:0.0.1-SNAPSHOT
```
